...
>
  ...
  <div class="card xl:w-1/2 md:w-2/3 w-full h-full p-8 items-center space-y-6">
    <label class="label">
      ...
      <select
        bind:value={tokenX}
        class="select !bg-surface-50-900-token font-heading-token text-secondary-600-300-token placeholder:text-secondary-600-300-token/50 font-bold"
        title="Select Token"
      >
    ...
    <label class="label">
      ...
      <input
        ...
        class="input !bg-surface-50-900-token font-heading-token text-secondary-600-300-token placeholder:text-secondary-600-300-token/50 font-bold"
        type="number"
        inputmode="decimal"
