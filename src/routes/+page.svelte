...
{#if ready}
  <div
    ...
    class="container h-full mx-auto flex md:flex-row flex-col-reverse justify-center md:space-x-24 space-y-12 items-center"
  >
    <div class="block space-y-4 md:w-2/3 w-full p-6">
      ...
      <p>
        ...
        >
          Liquidity Book docs
        </a>). The protocol retains the key features of its predecessor, such
        as:
      </p>
      <ul class="list-disc ml-4">
        <li class="list-item">
          ...
          <span>
            Enabling token swaps with zero slippage within designated bins
          </span>
        </li>
        <li class="list-item">
      ...
      <h2 class="font-semibold sm:max-w-none max-w-[70%]">
        Liquidity Book vs Uniswap V3
      </h2>
      <p>
        Both Liquidity Book and Uniswap V3 are concentrated liquidity AMMs with
        some subtle differences:
      </p>
      <ul class="list-disc ml-4">
        <li>Price ranges are divided into bins instead of ticks</li>
        <li>
          Bins employ a constant sum invariant instead of constant product
        </li>
        <li>Bin steps can exceed 1 basis point</li>
        <li>Liquidity is aggregated vertically instead of horizontally</li>
        <li>Liquidity positions are fungible</li>
        <li>
          Liquidity positions can be distributed in any desired shape, without
          restrictions to uniform distribution across the price range
        </li>
        <li>
          Swap fees consist of fixed and variable pricing, enabling the AMM to
          impose higher fees during periods of heightened market volatility
        </li>
      </ul>
    </div>
