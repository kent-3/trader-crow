...
<div
  ...
  class="flex lg:flex-row flex-col p-4 h-full mx-auto xl:justify-even justify-center xl:items-start items-center gap-6"
>
  ...
  <div class="card xl:w-[49%] w-full h-auto px-8 py-6 items-center space-y-6">
    ...
    >
      ...
      <Tab bind:group={tabSet} name="remove" value={1}>Remove Liquidity</Tab>
      <!-- ... -->
        ...
        {#if tabSet === 0}
          <div in:fade={{ duration: 200 }} class="space-y-8">
            <div class="space-y-2">
              ...
              <div
                class="input-group input-group-divider grid-cols-[1fr_80px] !bg-surface-50-900-token font-heading-token text-secondary-600-300-token font-bold"
              >
                <input
                  bind:value={inputX}
                  type="number"
                ...
                />
                <div
                  class="input-group-shim font-normal text-sm !justify-center"
                >
                  sSCRT
                </div>
              </div>
            ...
            <div class="space-y-4">
              ...
              <div class="flex flex-wrap justify-evenly gap-y-4">
                <button
                  class="btn variant-ringed-surface card-hover p-2"
                  class:selected={shape === 0}
                  on:click={() => (shape = 0)}
                >
                ...
                >
                  <div class="flex flex-col items-center">
                    ...
                    <p class="!text-xs font-heading-token font-bold">Curve</p>
                  </div>
                </button>
                <button
                  class="btn variant-ringed-surface card-hover p-2"
                  class:selected={shape === 2}
                  on:click={() => (shape = 2)}
                >
                  <div class="flex flex-col items-center">
                    <svg
                    ...
                    <p class="!text-xs font-heading-token font-bold">Bid-Ask</p>
                  </div>
                </button>
              </div>
            </div>
            <div class="flex flex-nowrap flex-row justify-between items-center">
              ...
              <TabGroup
                ...
                class="font-heading-token font-bold"
              >
                <Tab bind:group={tabSetBy} name="add" value={0}>By Range</Tab>
            ...
            {#if tabSetBy == 0}
              <div class="flex flex-col space-y-4">
                ...
                <div
                  class="grid sm:grid-cols-[minmax(0,_1fr)_minmax(0,_1fr)_90px] sm:grid-rows-none grid-rows-[minmax(0,_1fr)_minmax(0,_1fr)_90px] gap-2"
                >
                  <div class="flex flex-col justify-start space-y-2">
                    <p>Min Price:</p>
                    <div
                      class="input-group input-group-divider grid-cols-[1fr_105px] !bg-surface-50-900-token font-heading-token text-secondary-600-300-token font-bold"
                    >
                      <input
                        type="number"
                        name=""
                        ...
                        placeholder="0.0"
                        value={nice(
                          (1 - (100 * (0.5 - start) * binStep) / 10_000) * price
                        )}
                      />
                      <div
                        class="input-group-shim !px-2 !bg-surface-50-900-token font-normal text-xs !justify-center"
                      >
                        SILK per sSCRT
                      </div>
                    </div>
                  ...
                  <div class="flex flex-col justify-start space-y-2">
                    ...
                    >
                      <input
                        ...
                        placeholder="0.0"
                        value={nice(
                          (1 + (100 * (end - 0.5) * binStep) / 10_000) * price
                        )}
                      />
                      <div
                        class="input-group-shim !px-2 !bg-surface-50-900-token font-normal text-xs !justify-center"
                  ...
                  <div class="flex flex-col justify-start space-y-2">
                    ...
                    <input
                      ...
                      min="0"
                      max="100"
                      value={(100 * (end - start)).toFixed(0)}
                      class="input !bg-surface-50-900-token font-heading-token text-secondary-600-300-token font-bold"
                    />
                  </div>
                </div>
                <button
                  on:click={() => reset()}
                  class="btn hover:variant-soft-primary dark:text-primary-400 text-primary-500 inline-flex items-center content-center self-end"
                >
                  <svg
                    width="16"
                    height="15"
            ...
            {:else if tabSetBy == 1}
              <div class="grid sm:grid-cols-2 grid-cols-1 gap-2">
                <div class="flex flex-col justify-start space-y-2">
                  <p>Target Price:</p>
                  <div
                    class="input-group input-group-divider grid-cols-[minmax(0,_1fr)_105px] !bg-surface-50-900-token font-heading-token text-secondary-600-300-token font-bold"
                  >
                    <input
                      type="number"
                      name=""
                ...
                <div class="flex flex-col justify-start space-y-2">
                  <p>Range Min:</p>
                  <div
                    class="input-group opacity-60 input-group-divider grid-cols-[minmax(0,_1fr)_105px] !bg-surface-50-900-token font-heading-token text-secondary-600-300-token font-bold"
                  >
                    <input
                      disabled
                      type="number"
                      ...
                      id=""
                      placeholder="0.0"
                      value={nice(price * (1 - (binRadius * binStep) / 10_000))}
            ...
            {#if !$isAccountAvailable}
              <button
                on:click={() => setupKeplr()}
                class="btn w-full variant-ghost-primary mt-4 font-heading-token font-bold"
              >
                Connect Wallet
              </button>
            {:else if allowanceX == "0" || allowanceY == "0"}
              <button
