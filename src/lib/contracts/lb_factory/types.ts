...
export interface GetNumberOfQuoteAssetsQuery {
  get_number_of_quote_assets: object;
}
...
export interface GetAllBinStepsQuery {
  get_all_bin_steps: object;
}

export interface GetOpenBinStepsQuery {
  get_open_bin_steps: object;
}
