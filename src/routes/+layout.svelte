...
<!-- I can't figure out how to ignore these errors -->
<Toast
  duration=400
  width="sm:max-w-[32rem] sm:min-w-[24rem] w-full"
  position="br"
...
<AppShell>
  <svelte:fragment slot="header">
    ...
    <AppBar
      ...
      shadow="shadow-md"
      regionRowMain="md:overflow-x-hidden overflow-x-scroll"
    >
      <svelte:fragment slot="lead">
        ...
        <button class="!text-center">
          <strong class="text-xl uppercase font-heading-token"
            >Trader Crow</strong
          >
        </button>
      </svelte:fragment>
      <svelte:fragment>
        <div class="pl-4 flex space-x-4">
          <a href="{base}/" class="">
            <button
              class="btn font-heading-token font-bold variant-ghost-secondary"
              >Home</button
            >
          </a>
